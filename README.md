...
- [ ] Successfully mint all 1,000 birds ( 7000-7999) in the "Eggstravaganza" flock.
- [ ] Make public the (merkle-tree, images, species, audio) files for the "Eggstravaganza" flock.
...
- [ ] TBD: Freeze metadata url permanently.
